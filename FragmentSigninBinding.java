...
public final class FragmentSigninBinding implements ViewBinding {
  ...
  private FragmentSigninBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatButton button,
  ...
  public static FragmentSigninBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.sig_In;
      TextView sigIn = ViewBindings.findChildViewById(rootView, id);
      if (sigIn == null) {
        break missingId;
      }

      return new FragmentSigninBinding((ConstraintLayout) rootView, button, confirmPassEt,
          confirmPasswordLayout, emailEt, emailLayout, passET, passwordLayout, sigIn);
    }
